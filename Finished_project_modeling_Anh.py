...
# Evaluate the performance using sklearn.metrics.classification_report
from sklearn.metrics import classification_report

rf_report = classification_report(y_test, rf_predictions)
nn_report = classification_report(y_test, nn_predictions)

print('Random forest''s classification report: \n', rf_report)
print('Neural Network''s classification report: \n', nn_report)


# In[18]:


# Evaluate the performance using sklearn.metrics.recall_score:
...
print('Random forest''s recall score: ', rf_recall)
print('Neural Network''s recall score: ', nn_recall)
...
rf_precision_score = precision_score(y_test, rf_predictions, average='micro')
nn_precision_score = precision_score(y_test, nn_predictions, average='micro')

print('Random forest''s precision score: ', rf_precision_score)
print('Neural Network''s precision score: ', nn_precision_score)
